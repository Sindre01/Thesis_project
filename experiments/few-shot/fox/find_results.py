...
def main(
    ...
    for example_selector_type in example_selector_types:
        for experiment_type in experiment_types:
            runs_folder = f"{project_dir}/experiments/few-shot/fox/{PHASE.value}_runs/{example_selector_type}/{experiment_type}/{eval_method}"  
            ...
            output_dir = f"{project_dir}/experiments/few-shot/fox/{results_type}/{example_selector_type}/{experiment_type}/{eval_method}/"
