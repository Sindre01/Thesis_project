...
# Configuration
EXPERIMENT="SynCode"                    # Experiment ('few-shot' or 'COT')
...
NODE_LIST=gpu-9,gpu-7,gpu-8,gpu-14   # List of nodes that the job can run on gpu-9,gpu-7,gpu-8,gpu-14
...
OLLAMA_PORT="11427"                       # Remote port where Ollama listens. If different parallell runs, change ollama_port to avoid conflicts if same node is allocated.
