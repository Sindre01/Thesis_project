...
MEM_PER_GPU="30G"                       # Memory per GPU. 
...
OLLAMA_PORT="11499"                       # Remote port where Ollama listens. If different parallell runs, change ollama_port to avoid conflicts if same node is allocated.
